...
impl Chunk {
    ...
    pub fn reset(&self) {
        ...
        *self.number_of_blocks.write() = CHUNK_VOLUME;
        *self.active_faces.write() = BitVec::from_elem(6 * CHUNK_VOLUME as usize, false);
        *self.ao_vertices.write() = vec![[[0; 4]; 6]; CHUNK_VOLUME as usize];
    ...
    pub fn full_of_block(block: BlockID) -> Self {
        ...
        Self {
            ...
            number_of_blocks: RwLock::new(CHUNK_VOLUME),
    ...
    pub fn set_block(&self, x: u32, y: u32, z: u32, block: BlockID) {
        ...
        if self.blocks.read()[index].is_air() {
